                ...
                {showSuccess ? (
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-300 font-bold text-sm mb-2">
                                    City <span className="text-white-400">*</span>
                                </label>
                                <input
                                    type="text"
                                    name="city"
                            ...
                            <div className="flex justify-center">
                                <button
                                    ...
                                    className={`bg-[#8B5CF6] text-white font-semibold py-3 px-8 rounded-full flex items-center gap-2 hover:bg-[#7C4FE0] transition-colors shadow-[0_0_20px_rgba(139,92,246,0.4)] hover:shadow-[0_0_30px_rgba(139,92,246,0.6)] ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                                >
                                    <span>✦</span>
